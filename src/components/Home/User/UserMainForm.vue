...
<div class="">
  ...
  <transition enter-active-class="animated fadeIn">
    <form class="mt-3 col-md-12 mx-auto" id="addUserForm" autocomplete="off">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline">
        ...
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-phone fa-fw" aria-hidden="true"></i></span>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-address-card-o fa-fw" aria-hidden="true"></i></span>
            <input type="text" class="form-control" id="inputAddress" placeholder="Postal Address" v-model="form.address">
          </div>
        </div>
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-envelope fa-fw" aria-hidden="true"></i></span>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-id-badge fa-fw" aria-hidden="true"></i></span>
        ...
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-usd fa-fw" aria-hidden="true"></i></span>
      ...
      <div class="form-row d-flex w-100 mx-auto">
        <div class="form-group col-md-3">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-birthday-cake" aria-hidden="true"></i></span>
            <input type="text" class="form-control" id="dob" v-model="form.dob" placeholder="Date of Birth *" required>
          </div>
        </div>
        <div class="form-group col-md-3">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-venus-mars" aria-hidden="true"></i></span>
        ...
        <div class="form-group col-md-6">
          <div class="input-group">
            <span class="input-group-addon d-none d-lg-inline"><i class="fa fa-user-circle-o" aria-hidden="true"></i></span>
      ...
      <div class="form-row d-lg-none d-block">
        <div class="form-group col-md-12">
          <button class="btn btn-warning btn-block" @click.prevent="showDiag">Next &nbsp;<i class="fa fa-angle-double-right fa-lg" aria-hidden="true" v-if="addPatientPersonalSpinner===false"></i> <i class="fa fa-spinner fa-lg" aria-hidden="true" v-if="addPatientPersonalSpinner===true"></i></button>
          <button class="btn btn-block btn-warning resetbtn" @click.prevent="quitProcess">Reset &nbsp;<i class="fa fa-repeat" aria-hidden="true"></i></button>
        </div>
      </div>
